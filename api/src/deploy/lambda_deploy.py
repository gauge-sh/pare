...
def translate_python_version_to_lambda_runtime(python_version: str) -> str:
    ...
    if runtime_version not in LAMBDA_RUNTIMES:
        raise ValueError(f"Python version: {python_version} does not match a Lambda runtime.")
    return runtime_version


def deploy_python_lambda_function(function_name: str, zip_file: Path, python_version: str, handler: str = "lambda_function.lambda_handler"):
